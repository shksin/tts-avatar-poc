...
var TTSVoice = "en-AU-WilliamNeural" //en-US-AndrewMultilingualNeural" // 
...
function speakNext(text, endingSilenceMs = 0) {
  let ssml = `<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='http://www.w3.org/2001/mstts' xml:lang='en-AU'><voice name='${TTSVoice}'><mstts:leadingsilence-exact value='0'/>${text}<prosody volume="loud"/></voice></speak>`
  if (endingSilenceMs > 0) {
    ssml = `<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='http://www.w3.org/2001/mstts' xml:lang='en-AU'><voice name='${TTSVoice}'><mstts:leadingsilence-exact value='0'/>${text}<break time='${endingSilenceMs}ms' /><prosody volume="loud"/></voice></speak>`
  }
...
function connectToAvatarService() {
  ...
  switch(TalkingAvatarCharacter) {
    case "Lisa":
      ...
      TTSVoice = "en-AU-NatashaNeural" //en-US-AvaMultilingualNeural" //
      break    
    case "Max":
      TalkingAvatarStyle = "business"
      TTSVoice = "en-AU-WilliamNeural" //en-US-AndrewMultilingualNeural" // 
      break
...
async function greeting() {
  text = `Howdy, my name is ${TalkingAvatarCharacter}. How can I help you?`;
  addToConversationHistory(text, "light")

  var spokenText = `<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='http://www.w3.org/2001/mstts' xml:lang='en-AU'><voice name='${TTSVoice}'><mstts:leadingsilence-exact value='0'/>${text}<prosody volume="loud"/></voice></speak>`
